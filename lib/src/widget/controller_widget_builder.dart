...
class DefaultIJKControllerWidgetState extends State<DefaultIJKControllerWidget>
  ...
  late StreamSubscription controllerSubscription;
  ...
  Widget createTooltipWidgetWrapper(Widget widget) {
    var typography = Typography.material2014(platform: TargetPlatform.android);
  ...
  dynamic? wrapHorizontalGesture(dynamic function) =>
      widget.horizontalGesture == true ? function : null;

  dynamic? wrapVerticalGesture(dynamic function) =>
